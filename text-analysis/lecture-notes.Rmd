...
```{r}
docs.df <-read.csv("Data/women.csv", header=TRUE) #read in CSV file
...
```{r}
# Subset into 2 dtms
shelby <- subset(dtm,author=="Shelby",select = -author") # should have 1102 obs.
sessions <- subset(dtm,author=="Sessions",select = -author) # should have 236 obs.
```
