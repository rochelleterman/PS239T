...
## 1.1 Comparing Songs on the Thriller Album
...
## 1.2 Visualizing Plot using Sentiments
...
It is worth noting at this point that `qdap` has powerful functionality to visualize a discourse by various facets:
...
```
Now we have a data set capturing sentiments over time. Let's plot it.
...
`qdap` has other dictionaries to measure language formality, diversity, readability, etc. It also has other cool tools to analyze word usage, character usage, parts of speech, etc.
