...
Using the code provided in class, run Mallet on the `women` corpus with 15 topics. Return topic labels with the most probably words for each topic.
...
i. Install the `stm` package and read the help file carefully. Estimate a topic model with 15 topics that estimates on the `region` of origin for topic prevalence. 
...
iii. Plot the topic estimation of one topic of your choice. 
