...
2. [Group-wise Operations](#2-group-wise-operations)
...
### 1b. Proprietaries (e.g.: .dta, .spss, .ssd)
...
### 1d. Other (e.g.: html tables, html, xml, json) 
...
### 2c: Selecting functions and writing commands
