...
[Note: GitHub will provide a platform to share the materials of the course, as well as the students’ final projects, with an audience beyond the class.]
...
[Note: We plan on using a curriculum similar to Software Carpentry’s offerings, which are highly developed, effective, and open access. We have discussed a possible collaboration between Software Carpentry and this course as they expand their offerings into the Social Sciences and Humanities.]
...
[Note: We have already built relationships with members of the D-Lab community and others who are interested in serving as guest experts.]
...
[TBD: Will require either BCE or a la carte installation. We have reached out to Research IT who are very interested in supporting us technologically with this class.]
...
1.	Introduction
2.	Unix, Bash, and Git: [Sample Materials and Exercises]
3.	Python
4.	Python
5.	Python
6.	R
